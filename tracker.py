...
file = open("C:/Users/asiff/Desktop/speedrecord.txt","w")
file.write("ID \t SPEED\n------\t-------\n")
file.close()
...
class EuclideanDistTracker:
    ...
    def capture(self,img,x,y,h,w,sp,id):
        if(self.capf[id]==0):
            ...
            file = 'C:/Users/asiff/Desktop//project//' + n + '.jpg'
            cv2.imwrite(file, crop_img)
            self.count += 1
            filet = open("C:/Users/asiff/Desktop/project/speedrecord.txt", "a")
            if(sp>limit):
                file2 = 'C:/Users/asiff/Desktop/project//exceeded//' + n + '.jpg'
    ...
    #TEXT FILE SUMMARY
    def end(self):
        file = open("C:/Users/asiff/Desktop/project/speedrecord.txt", "a")
        file.write("\n-------------\n")
        file.write("-------------\n")
        file.write("SUMMARY\n")
        file.write("-------------\n")
