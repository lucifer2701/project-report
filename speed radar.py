...
cap = cv2.VideoCapture("C:/Users/asiff/Videos/Cars_On_Highway.mp4")
f = 25
w = int(1000/(f-1))
print(w)
...
while True:
    ...
    cv2.line(roi, (0, 410), (1280, 410), (0, 0, 255), 2)
    cv2.line(roi, (0, 430), (1280, 430), (0, 0, 255), 2)

    cv2.line(roi, (0, 235), (1280, 235), (0, 0, 255), 2)
    cv2.line(roi, (0, 255), (1280, 255), (0, 0, 255), 2)
